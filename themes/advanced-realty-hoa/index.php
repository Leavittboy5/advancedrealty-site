        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <section class="bg-white rounded-xl shadow-2xl mb-8 border-t-8 border-adv-gold overflow-hidden flex flex-col md:flex-row">
                ...
                <div class="p-8 md:p-12 md:w-3/5 flex flex-col justify-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="<?php echo esc_url(get_hoa_var('owner_portal_url')); ?>" target="_blank" class="inline-block w-full sm:w-auto text-center px-8 py-4 bg-adv-gold text-white font-bold text-lg rounded-xl shadow-xl hover:bg-adv-gold-dark transition duration-300 transform hover:scale-[1.01]">
            ...
            <section id="documents" class="mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-hoa-amber hover:shadow-xl transition duration-300">
                        ...
                        <a href="<?php echo esc_url(get_hoa_var('acc_form_url')); ?>" target="_blank" class="text-adv-gold font-semibold hover:underline text-base flex items-center">
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-hoa-amber hover:shadow-xl transition duration-300">
                        ...
                        <a href="<?php echo do_shortcode('[hoa_document_link]'); ?>" target="_blank" class="text-adv-gold font-semibold hover:underline text-base flex items-center">View All Documents →</a>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-hoa-amber hover:shadow-xl transition duration-300">
                        ...
                        <a href="https://services.commerce.utah.gov/hoa/" target="_blank" class="text-adv-gold font-semibold hover:underline text-base flex items-center">Search Utah Registry →</a>
                    </div>
                </div>
            </section>
            ...
            <section id="contact" class="mb-12 bg-white p-8 rounded-xl shadow-lg">
                 <div class="flex flex-col md:flex-row md:items-center justify-between border-b pb-4 mb-6">
                     ...
                     <a href="https://advancedrealty.com/contact-about-us/" target="_blank" class="inline-flex justify-center items-center px-6 py-3 bg-adv-gold text-white font-bold rounded-lg hover:bg-adv-gold-dark transition duration-300 shadow-md">
                         Contact Us
                ...
                <div class="px-6 py-8 md:px-8 flex flex-col md:flex-row items-center justify-between">
                    <div class="mb-6 md:mb-0 flex items-center text-left w-full md:w-auto">
                        <div class="bg-gray-800 p-4 rounded-full mr-5 border border-gray-700 hidden sm:block">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-lucide="file-check-2" aria-hidden="true" class="lucide lucide-file-check-2 w-8 h-8 text-adv-gold"><path d="M10.5 22H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.706.706l3.588 3.588A2.4 2.4 0 0 1 20 8v6"></path><path d="M14 2v5a1 1 0 0 0 1 1h5"></path><path d="m14 20 2 2 4-4"></path></svg>
                        </div>
                        <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 flex flex-col hover:shadow-2xl transition-shadow duration-300">
                        <div class="relative h-48 w-full">
                            ...
                            <div class="absolute inset-0 bg-slate-900/40 flex flex-col justify-center items-center p-4">
                                <svg class="w-12 h-12 text-adv-gold mx-auto mb-3 drop-shadow-md" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                        ...
                        <div class="p-6 flex-grow flex flex-col justify-between">
                            ...
                            <a href="https://advancedrealty.com/residential-management/" target="_blank" class="block w-full text-center px-4 py-3 bg-adv-gold text-white font-bold rounded-lg hover:bg-adv-gold-dark transition duration-300">Get a Free Quote</a>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 flex flex-col hover:shadow-2xl transition-shadow duration-300">
                        <div class="relative h-48 w-full">
                            ...
                            <div class="absolute inset-0 bg-slate-900/40 flex flex-col justify-center items-center p-4">
                                <svg class="w-12 h-12 text-adv-gold mx-auto mb-3 drop-shadow-md" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 flex flex-col hover:shadow-2xl transition-shadow duration-300">
                        <div class="relative h-48 w-full">
                            ...
                            <div class="absolute inset-0 bg-slate-900/40 flex flex-col justify-center items-center p-4">
                                <svg class="w-12 h-12 text-adv-gold mx-auto mb-3 drop-shadow-md" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
