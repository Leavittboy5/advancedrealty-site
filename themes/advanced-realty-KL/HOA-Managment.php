    ...
    <div class="max-w-4xl mx-auto px-4 text-center">
        ...
        <form method="GET" action="" target="_blank" class="flex flex-col sm:flex-row justify-center items-center gap-4 max-w-lg mx-auto w-full">
            <div class="relative w-full">
                ...
                <select name="hoa_url" required class="block w-full pl-10 pr-10 py-3 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-adv-gold focus:border-adv-gold sm:text-sm rounded-lg shadow-sm appearance-none bg-gray-50 border text-gray-700 font-medium">
...
<section class="bg-gray-900 border-y border-gray-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col md:flex-row items-center justify-between">
        <div class="mb-6 md:mb-0 flex items-center text-left w-full md:w-auto">
            <div class="bg-gray-800 p-4 rounded-full mr-5 border border-gray-700 hidden sm:block"><i data-lucide="file-check-2" class="w-8 h-8 text-adv-gold"></i></div>
            <div>
        ...
        <a href="https://advr.twa.rentmanager.com/ApplyNow?propertyID=837&locations=1" target="_blank" class="w-full md:w-auto bg-adv-gold hover:bg-adv-gold-dark text-white font-bold py-3 px-8 rounded-xl shadow-lg transition duration-300 transform hover:scale-105 whitespace-nowrap flex items-center justify-center">Document Request <i data-lucide="arrow-right" class="w-5 h-5 ml-2"></i></a>
    </div>
</section>
        ...
        <div>
            ...
            <div class="space-y-6">
                <div class="flex items-start">
                    <div class="flex-shrink-0 p-3 bg-white rounded-lg shadow-sm border border-gray-100"><i data-lucide="scale" class="w-6 h-6 text-adv-gold"></i></div>
                    <div class="ml-4">
                ...
                <div class="flex items-start">
                    <div class="flex-shrink-0 p-3 bg-white rounded-lg shadow-sm border border-gray-100"><i data-lucide="calculator" class="w-6 h-6 text-adv-gold"></i></div>
                    <div class="ml-4">
                ...
                <div class="flex items-start">
                    <div class="flex-shrink-0 p-3 bg-white rounded-lg shadow-sm border border-gray-100"><i data-lucide="calendar" class="w-6 h-6 text-adv-gold"></i></div>
                    <div class="ml-4">
 ...
 */
?>
<div class="adv-promo-banner bg-slate-900 rounded-2xl overflow-hidden shadow-xl my-12 flex flex-col md:flex-row items-center border-l-8 border-adv-gold">
    <div class="p-8 md:p-12 flex-grow">
        <span class="text-adv-gold font-bold uppercase tracking-widest text-sm">Need Help With Your Rental?</span>
        ...
        <div class="mt-8">
            <a href="/residential-management" class="inline-block bg-adv-gold hover:bg-white hover:text-adv-gold text-white font-bold py-4 px-8 rounded-lg transition duration-300 shadow-lg">View Residential Services</a>
        </div>
    </div>
    <div class="hidden lg:block w-1/3 bg-adv-gold/10 p-12 text-center">
