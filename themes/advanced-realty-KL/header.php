...
<header class="bg-white shadow-xl sticky top-0 z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        ...
        <nav class="hidden md:flex space-x-4 items-center h-full">
            ...
            <a href="https://stgeorgestorage.com" target="_blank" class="inline-flex items-center justify-center px-4 py-2 border-2 border-adv-teal text-sm font-bold rounded-lg text-adv-teal hover:bg-slate-50 hover:border-slate-900 hover:text-slate-900 transition-all duration-300 shadow-sm hover:shadow-md">
                Storage Facilities
                <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path></svg>
            </a>
            
            <div class="relative group h-full flex items-center">
                <button class="bg-adv-teal text-sm font-bold text-white hover:opacity-90 py-2.5 px-5 rounded-lg flex items-center shadow-md hover:shadow-lg transition duration-300">
                    Client Portals
                    <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                </button>
