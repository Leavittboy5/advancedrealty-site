...
<header class="bg-white shadow-xl sticky top-0 z-50 border-b-4 border-adv-gold">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        ...
        <nav class="hidden md:flex space-x-4 items-center h-full">
            ...
            <a href="https://stgeorgestorage.com" target="_blank" class="inline-flex items-center justify-center px-4 py-2 border-2 border-adv-gold text-sm font-bold rounded-lg text-adv-gold hover:bg-adv-gold hover:border-adv-gold hover:text-white transition-all duration-300 shadow-sm hover:shadow-md">
                Storage Facilities
            ...
            <div class="relative group h-full flex items-center">
                ...
                <div class="dropdown-menu absolute right-0 top-full pt-2 w-48 opacity-0 invisible group-hover:opacity-100 group-hover:visible transform translate-y-2 group-hover:translate-y-0 transition-all duration-200 origin-top-right z-50">
                    <div class="bg-white rounded-lg shadow-xl border border-gray-100 overflow-hidden">
                        <a href="http://ownerwebaccess.rentmanager.com/OwnerLogin.aspx?CorpID=advr" target="_blank" class="block px-5 py-3 text-gray-800 hover:bg-gray-50 hover:text-adv-gold transition-colors text-sm font-medium border-b border-gray-50">Owner Portal</a>
                        <a href="<?php echo home_url('/Renter-resources'); ?>" class="block px-5 py-3 text-gray-800 hover:bg-gray-50 hover:text-adv-gold transition-colors text-sm font-medium border-b border-gray-50">Renter Portal</a>
                        <a href="https://advancedrealty.com/hoa-management/" class="block px-5 py-3 text-gray-800 hover:bg-gray-50 hover:text-adv-gold transition-colors text-sm font-medium border-b border-gray-50">HOA Portal</a>
                        <a href="http://residentwebaccess.rentmanager.com/CustomerLogin.aspx?corpid=advr" target="_blank" class="block px-5 py-3 text-gray-800 hover:bg-gray-50 hover:text-adv-gold transition-colors text-sm font-medium border-b border-gray-50">Commercial Portal</a>
                        <a href="http://residentwebaccess.rentmanager.com/CustomerLogin.aspx?corpid=advr" target="_blank" class="block px-5 py-3 text-gray-800 hover:bg-gray-50 hover:text-adv-gold transition-colors text-sm font-medium">Storage Portal</a>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <div class="md:hidden flex flex-col items-end space-y-2 w-56">
            ...
            <div class="relative w-full">
                ...
                <div id="mobile-client-portals" class="hidden absolute right-0 top-full mt-2 w-full bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden z-50">
                    <a href="http://ownerwebaccess.rentmanager.com/OwnerLogin.aspx?CorpID=advr" target="_blank" class="block px-4 py-3 text-gray-800 hover:bg-gray-50 hover:text-adv-gold transition-colors text-sm font-medium border-b border-gray-50">Owner Portal</a>
                    <a href="<?php echo home_url('/Renter-resources'); ?>" class="block px-4 py-3 text-gray-800 hover:bg-gray-50 hover:text-adv-gold transition-colors text-sm font-medium border-b border-gray-50">Renter Portal</a>
                    <a href="https://advancedrealty.com/hoa-management/" class="block px-4 py-3 text-gray-800 hover:bg-gray-50 hover:text-adv-gold transition-colors text-sm font-medium border-b border-gray-50">HOA Portal</a>
                    <a href="http://residentwebaccess.rentmanager.com/CustomerLogin.aspx?corpid=advr" target="_blank" class="block px-4 py-3 text-gray-800 hover:bg-gray-50 hover:text-adv-gold transition-colors text-sm font-medium border-b border-gray-50">Commercial Portal</a>
                    <a href="http://residentwebaccess.rentmanager.com/CustomerLogin.aspx?corpid=advr" target="_blank" class="block px-4 py-3 text-gray-800 hover:bg-gray-50 hover:text-adv-gold transition-colors text-sm font-medium">Storage Portal</a>
                </div>
            </div>
