...
<!-- Hero Slider Section -->
<section class="relative w-full h-[500px] lg:h-[650px] bg-gray-900">
                    ...
                    <div class="relative z-10 flex flex-col items-center justify-center w-full h-full px-4 sm:px-6 lg:px-8">
                        <div class="max-w-4xl mx-auto text-center">
                            ...
                            <?php if( $button_text && $button_link ): ?>
                                <a href="<?php echo esc_url($button_link); ?>" class="bg-adv-teal hover:bg-adv-teal-dark text-white font-bold text-lg py-3 px-10 rounded-xl shadow-2xl transition duration-300 transform hover:scale-105 inline-block border-2 border-adv-teal hover:border-white">
                ...
                <div class="swiper-slide relative w-full h-full">
                    ...
                    <div class="relative z-10 flex flex-col items-center justify-center w-full h-full px-4 sm:px-6 lg:px-8">
                        <div class="max-w-4xl mx-auto text-center">
                            ...
                            <a href="<?php echo home_url('/real-estate'); ?>" class="bg-adv-teal hover:bg-adv-teal-dark text-white font-bold text-lg py-3 px-10 rounded-xl shadow-2xl transition duration-300 transform hover:scale-105 inline-block border-2 border-adv-teal hover:border-white">
                                View Listings &rarr;
                            </a>
                        </div>
                    </div>
                ...
                <div class="swiper-slide relative w-full h-full">
                    ...
                    <div class="relative z-10 flex flex-col items-center justify-center w-full h-full px-4 sm:px-6 lg:px-8">
                        <div class="max-w-4xl mx-auto text-center">
                            ...
                            <a href="https://advancedrealty.com/rental-listings/" class="bg-adv-teal hover:bg-adv-teal-dark text-white font-bold text-lg py-3 px-10 rounded-xl shadow-2xl transition duration-300 transform hover:scale-105 inline-block border-2 border-adv-teal hover:border-white">
                                Search Rentals &rarr;
                            </a>
                        </div>
                    </div>
                ...
                <div class="swiper-slide relative w-full h-full">
                    ...
                    <div class="relative z-10 flex flex-col items-center justify-center w-full h-full px-4 sm:px-6 lg:px-8">
                        <div class="max-w-4xl mx-auto text-center">
                            ...
                            <a href="<?php echo home_url('/residential-management'); ?>" class="bg-adv-teal hover:bg-adv-teal-dark text-white font-bold text-lg py-3 px-10 rounded-xl shadow-2xl transition duration-300 transform hover:scale-105 inline-block border-2 border-adv-teal hover:border-white">
                                Get a Quote &rarr;
                            </a>
                        </div>
                    </div>
                ...
                <div class="swiper-slide relative w-full h-full">
                    ...
                    <div class="relative z-10 flex flex-col items-center justify-center w-full h-full px-4 sm:px-6 lg:px-8">
                        <div class="max-w-4xl mx-auto text-center">
                            ...
                            <a href="<?php echo home_url('/hoa-management'); ?>" class="bg-adv-teal hover:bg-adv-teal-dark text-white font-bold text-lg py-3 px-10 rounded-xl shadow-2xl transition duration-300 transform hover:scale-105 inline-block border-2 border-adv-teal hover:border-white">
                                Inquire Now &rarr;
                            </a>
                        </div>
                    </div>
                ...
                <div class="swiper-slide relative w-full h-full">
                    ...
                    <div class="relative z-10 flex flex-col items-center justify-center w-full h-full px-4 sm:px-6 lg:px-8">
                        <div class="max-w-4xl mx-auto text-center">
                            ...
                            <a href="<?php echo home_url('/commercial-management'); ?>" class="bg-adv-teal hover:bg-adv-teal-dark text-white font-bold text-lg py-3 px-10 rounded-xl shadow-2xl transition duration-300 transform hover:scale-105 inline-block border-2 border-adv-teal hover:border-white">
                                View Services &rarr;
                            </a>
                        </div>
                    </div>
                ...
                <div class="swiper-slide relative w-full h-full">
                    ...
                    <div class="relative z-10 flex flex-col items-center justify-center w-full h-full px-4 sm:px-6 lg:px-8">
                        <div class="max-w-4xl mx-auto text-center">
                            ...
                            <a href="https://stgeorgestorage.com" target="_blank" class="bg-adv-teal hover:bg-adv-teal-dark text-white font-bold text-lg py-3 px-10 rounded-xl shadow-2xl transition duration-300 transform hover:scale-105 inline-block border-2 border-adv-teal hover:border-white">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <a href="<?php echo home_url('/real-estate'); ?>" class="service-card p-6 sm:p-8 block">
                <div class="text-6xl text-adv-teal mb-4"><i data-lucide="key" class="w-12 h-12"></i></div>
                ...
                <p class="font-semibold text-adv-teal text-sm flex items-center">Contact a Broker/View Listings &rarr;</p>
            </a>
            ...
            <a href="<?php echo home_url('/residential-management'); ?>" class="service-card p-6 sm:p-8 block">
                <div class="text-6xl text-adv-teal mb-4"><i data-lucide="users" class="w-12 h-12"></i></div>
                ...
                <p class="font-semibold text-adv-teal text-sm flex items-center">Get Your Management Quote &rarr;</p>
            </a>
            
            <a href="<?php echo home_url('/hoa-management'); ?>" class="service-card p-6 sm:p-8 block">
                <div class="text-6xl text-adv-teal mb-4"><i data-lucide="building-2" class="w-12 h-12"></i></div>
                ...
                <p class="font-semibold text-adv-teal text-sm flex items-center">Inquire About HOA Services &rarr;</p>
            </a>

            <a href="<?php echo home_url('/commercial-management'); ?>" class="service-card p-6 sm:p-8 block">
                <div class="text-6xl text-adv-teal mb-4"><i data-lucide="briefcase" class="w-12 h-12"></i></div>
                ...
                <p class="font-semibold text-adv-teal text-sm flex items-center">View Commercial Services &rarr;</p>
            </a>
