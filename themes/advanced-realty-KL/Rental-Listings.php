    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div class="flex flex-col gap-4 order-2 md:order-1 items-center md:items-start">
                <a href="https://advancedrealty.com/renter-resources/" class="w-full sm:w-64 justify-center inline-flex items-center bg-adv-gold hover:bg-adv-gold-dark text-white font-bold py-3 px-8 rounded-xl shadow-lg transition duration-300 transform hover:scale-105">
                    <i data-lucide="book-open" class="w-5 h-5 mr-2"></i>
                    View Renter Resources
                </a>
                <a href="#idx-listings" class="w-full sm:w-64 justify-center inline-flex items-center bg-white border-2 border-gray-200 hover:border-adv-gold text-gray-700 font-bold py-3 px-8 rounded-xl shadow-sm transition duration-300">
                    Browse Listings ↓
                </a>
            </div>
...
<section id="owner-quote" class="py-10 bg-gray-900 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row justify-between items-center text-center lg:text-left">
        ...
        <a href="https://advancedrealty.com/residential-management" class="bg-adv-gold hover:bg-adv-gold-dark text-white font-bold text-lg py-3 px-8 rounded-xl shadow-2xl transition duration-300 transform hover:scale-105 inline-block border-2 border-adv-gold hover:border-white">
...
<section class="bg-sky-700 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center text-center md:text-left rounded-xl p-6 border-l-8 border-adv-gold shadow-xl bg-white">
        ...
        <a href="https://stgeorgestorage.com" target="_blank" class="bg-adv-gold hover:bg-adv-gold-dark text-white font-bold text-lg py-3 px-8 rounded-xl shadow-2xl transition duration-300 transform hover:scale-105">
