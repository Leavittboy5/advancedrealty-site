<?php
/* Template Name: Advanced Realty - Terms and Conditions */
get_header(); 
?>
...
<main class="flex-grow py-12 bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 bg-white p-8 rounded-xl shadow-2xl border-t-8 border-adv-teal">
        ...
        <div class="policy-content space-y-6 text-gray-700">
            ...
            <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">3. SMS / Text Messaging Terms and Conditions</h2>
            <p>By providing your mobile phone number and opting in, you agree to receive SMS text messages from Trent W. Leavitt P.C., dba Advanced Realty related to property management, maintenance requests, community news, urgent notifications, and other service-related communications. Please read the following terms regarding our text messaging program carefully:</p>
            <ul class="list-disc pl-6 space-y-2">
                <li><strong>Program Name:</strong> Advanced Realty Alerts & Notifications.</li>
                <li><strong>Program Description:</strong> We use text messaging to send service-related notifications, lease updates, maintenance scheduling, and property alerts to opted-in users.</li>
            ...
            <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">4. User Conduct</h2>
            <p>You agree to use this website only for lawful purposes. You may not use the site in any way that causes, or may cause, damage to the website or impairment of the availability or accessibility of the website.</p>

            <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">5. Intellectual Property</h2>
            <p>All content, trademarks, and data on this website, including but not limited to software, text, graphics, and icons, are the property of or licensed to Trent W. Leavitt P.C., dba Advanced Realty and are protected by local and international legislation.</p>

            <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">6. Limitation of Liability</h2>
            <p>Trent W. Leavitt P.C., dba Advanced Realty will not be liable for any damages of any kind arising from the use of this site, including, but not limited to direct, indirect, incidental, punitive, and consequential damages.</p>

            <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">7. Indemnification</h2>
            <p>You agree to indemnify and hold harmless Trent W. Leavitt P.C., dba Advanced Realty and its agents from any claim, demand, or loss arising out of your breach of these Terms or your misuse of the website.</p>

            <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">8. Governing Law</h2>
            <p>These Terms and Conditions shall be governed by the laws of the <strong>State of Utah</strong>, without regard to its conflict of law principles.</p>
            
            <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">9. Termination</h2>
            <p>We can terminate your access for violating these terms.</p>

            <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">10. CTIA Compliance</h2>
            <p>Our service complies with CTIA guidelines. Please report any concerns regarding our messaging program to us directly.</p>

            <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">11. Changes to Terms</h2>
            <p>We may update these Terms to reflect changes in our service or applicable laws. Continued use of the service after such changes constitutes your acceptance of the revised Terms.</p>

            <h2 id="contact" class="text-2xl font-bold text-gray-900 mt-8 mb-4">12. Contact Information</h2>
