<?php
/* Template Name: Advanced Realty - Privacy Policy */
get_header(); 
?>
...
<main class="flex-grow py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 bg-white p-8 rounded-xl shadow-2xl border-t-8 border-adv-teal">
        ...
        <div class="policy-content space-y-6 text-gray-700">
            ...
            <h3 class="text-xl font-semibold text-gray-800 mt-6 mb-2">A. Mobile Phone Number</h3>
            <p>While on our website, through online applications, maintenance requests, showing requests, Tenant Web Access registration, site reservations, or general informational request forms we may collect your phone number to send and receive text messages.</p>

            <h3 class="text-xl font-semibold text-gray-800 mt-6 mb-2">B. User-Provided Information</h3>
            <p>Any additional information you provide helps us improve our services and provide better support. This includes data submitted through online forms, applications, contracts, and portals, such as:</p>
            <ul class="list-disc pl-6 space-y-2">
                <li>Contact details (Name, Email, Address).</li>
                <li>Financial and identity information (when applying for a rental or management service).</li>
                <li>Property and maintenance requests.</li>
            </ul>

            <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">2. How We Use Your Information</h2>
            <p>We use your data to deliver text messages and updates related to our services, improve our services and user experience, respond to your inquiries, provide customer support, and occasionally send promotional offers, alerts, communication about community news, urgent notifications, events, and other content.</p>

            <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">3. Message Content</h2>
            <p>Messages may include promotional offers, alerts, communication about community news, urgent notifications, events, and other content. Standard messaging rates may apply. Message frequency will vary.</p>
            ...
            <ul class="list-disc pl-6 space-y-2">
                ...
                <li><strong>Opt-Out:</strong> You may opt out of these communications at any time by replying STOP to any text message you receive from us. Reply HELP for more information.</li>
            </ul>

            <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">6. Data Retention</h2>
            <p>We retain your information as long as necessary for the purposes outlined in this policy or as required by Utah and federal laws (e.g., retaining rental application records and financial history for required periods).</p>

            <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">7. Your Rights and Choices</h2>
            <p>Depending on applicable law, you may have the right to request access to the personal data we hold about you, request that we correct any inaccurate personal data, or request that we delete your personal data (subject to our legal and service-related retention obligations).</p>
            
            <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">8. CTIA Compliance</h2>
            <p>Our services comply with CTIA guidelines. To report concerns or violations, contact us using the provided information.</p>
